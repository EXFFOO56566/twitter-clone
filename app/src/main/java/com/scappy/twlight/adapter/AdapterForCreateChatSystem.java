...
public class AdapterForCreateChatSystem extends RecyclerView.Adapter<AdapterForCreateChatSystem.MyHolder>{

    final Context context;
    final List<SystemModelForUsers> userList;

    public AdapterForCreateChatSystem(Context context, List<SystemModelForUsers> userList) {
