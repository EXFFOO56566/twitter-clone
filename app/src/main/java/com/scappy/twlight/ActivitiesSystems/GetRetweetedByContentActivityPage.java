...
public class GetRetweetedByContentActivityPage extends AppCompatActivity {
        ...
        ref.orderByChild("id").equalTo(hisUid)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterUsers = new AdapterForUsersSystem(GetRetweetedByContentActivityPage.this, userList);
