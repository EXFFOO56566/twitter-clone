...
public class StoryViewSystemActivityPage extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_seen.setOnClickListener(v -> {
            Intent intent = new Intent(StoryViewSystemActivityPage.this, GetViewedActivityPage.class);
    ...
    private void getStories(String userid){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                storiesProgressView.setStoriesListener(StoryViewSystemActivityPage.this);
    ...
    private void userInfo(String userid){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (Objects.requireNonNull(systemModelForUsers).getPhoto().isEmpty()){
                ...
                username.setOnClickListener(v -> {
                    Intent intent = new Intent(StoryViewSystemActivityPage.this, ContentUserProfileActivityPage.class);
