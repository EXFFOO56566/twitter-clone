...
import com.scappy.twlight.adapter.AdapterforAdminPostSystem;
...
public class GetPostReportListConentActivityPage extends AppCompatActivity {

    RecyclerView trendingRv;

    //Post
    AdapterforAdminPostSystem adapterPost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterPost = new AdapterforAdminPostSystem(this, postList);
